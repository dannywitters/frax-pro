...
const BaseLineChart: React.FC<NBaseLineChart.Props> = (props) => {
  ...
  const [dimensions, setDimensionsState] = React.useState<NBaseLineChart.Dimensions>({ height: 0, width: 0 })
  ...
  const actions: NBaseLineChart.Actions = {
    ...
    setDimensions: (_dimensions, cb) => _actions.setDimensions(setDimensionsState)(_dimensions, cb),
  ...
  const helpers: NBaseLineChart.Helpers = {
    ...
    computeValues: (cb?: Function) => _helpers.computeValues(props, state, actions, cb),
  }
