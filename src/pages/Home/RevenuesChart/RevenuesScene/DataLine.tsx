...
const calculateLine = (data: NBaseLineChart.Datum[], chart: NBaseLineChart.ChartValues): string =>
...
const DataLine: React.FC<Props> = ({ data, chart, color = '#126809' }) => {
  const d = calculateLine(data, chart)
  return d.match(/NaN|undefined|null/) ? null : <StyledDataLine {...{ d, color }} />
}
